...
def customer_volume():
	...
	logging.basicConfig(level=logging.DEBUG,
                    ...
                    filename='inc_vol_forecast_log.log',
                    filemode='w')
...
@app.route('/cust_dept_forecast', methods=['GET'])
def customer_dept_volume():
	...
	forecast_df['Month'] = forecast_df['Month'].dt.strftime('%Y-%m-%d')
	cust_dept_forecast = forecast_df.to_json(orient='records', date_format = 'iso')[1:-1].replace('},{', '} {')
	return cust_dept_forecast